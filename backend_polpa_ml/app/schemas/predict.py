...
class PredictRequest(BaseModel):
    ...
    container_tipo: Optional[str] = Field(None, description="Tipo de container")
    container_tamanho: Optional[str] = Field(None, description="Tamanho do container: 20ft ou 40ft")
